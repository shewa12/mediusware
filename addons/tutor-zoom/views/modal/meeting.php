...
<form class="tutor_assignment_modal_form">
    ...
    <div class="assignment-modal-form-wrap lesson-modal-form-wrap">
            ...
            <div class="tutor-option-field">
                <div class="tutor-option-gorup-fields-wrap">
                    <div class="tutor-option-group-field">
                        <input type="number" name="assignment_option[time_duration][value]" value="<?php echo tutor_utils()->get_assignment_option($meeting_id, 'time_duration.value', 0); ?>">
                    </div>
                    <div class="tutor-option-group-field">
                        <select name="assignment_option[time_duration][time]">
                            <option value="weeks" <?php selected('weeks', tutor_utils()->get_assignment_option($meeting_id, 'time_duration.time')); ?>>Weeks</option>
                            <option value="days"  <?php selected('days', tutor_utils()->get_assignment_option($meeting_id, 'time_duration.time')); ?>>Days</option>
                            <option value="hours"  <?php selected('hours', tutor_utils()->get_assignment_option($meeting_id, 'time_duration.time')); ?>>Hours</option>
                        </select>
                    </div>
                </div>
        ...
        <div class="tutor-option-field-row">
            ...
            <div class="tutor-option-field">
                <input type="number" name="assignment_option[total_mark]" value="<?php echo tutor_utils()->get_assignment_option($meeting_id, 'total_mark', 10) ?>">
        ...
        <div class="tutor-option-field-row">
            ...
            <div class="tutor-option-field">
                <input type="number" name="assignment_option[pass_mark]" value="<?php echo tutor_utils()->get_assignment_option($meeting_id, 'pass_mark', 5) ?>">
        ...
        <div class="tutor-option-field-row">
            ...
            <div class="tutor-option-field">
				...
				($meeting_id, 'upload_files_limit', 1) ?>">
        ...
        <div class="tutor-option-field-row">
            ...
            <div class="tutor-option-field">
				...
				($meeting_id, 'upload_file_size_limit', 2) ?>">
                <p class="desc"><?php echo sprintf(__('Define maximum file size attachment in %s', 'tutor-pro'), '<code>MB</code>') ?></p>
            </div>
        </div>

        <?php do_action('tutor_assignment_edit_modal_form_after', $meeting_id) ?>
