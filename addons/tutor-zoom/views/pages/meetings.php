...
// Order Filter
$order_filter = isset($_GET['order']) ? $_GET['order'] : 'upcoming';
    ...
    <div>
        ...
        <div>
            <select class="tutor-report-sort">
                <option <?php selected( $order_filter, 'upcoming' ); ?>><?php _e('Upcoming'); ?></option>
                <option <?php selected( $order_filter, 'previous' ); ?>><?php _e('Previous'); ?></option>
            </select>
        </div>
    </div>
</div>
        ...
        <table class="tutor-list-table">
            <thead>
                <tr>
                    ...
                    <th><?php _e('Meeting Token', 'tutor-pro'); ?></th>
                    <th><?php _e('Password', 'tutor-pro'); ?></th>
                    <th><?php _e('Host Name', 'tutor-pro'); ?></th>
                    <th><?php _e('Privacy', 'tutor-pro'); ?></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="details-button">
                                <a class="tutor-report-btn default" href="<?php echo admin_url('admin.php?page=tutor_report&sub_page=courses&course_id='.$course['id']); ?>"><?php _e('Edit', 'tutor-pro') ?></a>
                                <a href="<?php echo $course['link']; ?>" target="_blank"><i class="tutor-icon-garbage"></i></a>
                            </div>
                        </td>
                    </tr>
                <?php } ?>
